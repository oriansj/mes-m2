...
struct scm* mes_builtins(struct scm* a)  /* ((internal)) */
{
	...
	a = init_builtin(builtin_type, "prim:hash-ref", 3, &hash_ref, a);
	a = init_builtin(builtin_type, "prim:hashq-set!", 3, &hashq_set_x, a);
	...
	/* src/lib.mes */
	a = init_builtin(builtin_type, "prim:display", 1, &display, a);
	a = init_builtin(builtin_type, "prim:display-error", 1, &display_error, a);
	a = init_builtin(builtin_type, "prim:display-port", 2, &display_port, a);
	a = init_builtin(builtin_type, "prim:write", 1, &scm_write, a);
	a = init_builtin(builtin_type, "prim:write-error", 1, &write_error, a);
	a = init_builtin(builtin_type, "prim:write-port", 2, &write_port, a);
	a = init_builtin(builtin_type, "prim:exit", 1, &scm_exit, a);
	...
	a = init_builtin(builtin_type, "prim:type", 1, &type, a);
	...
	a = init_builtin(builtin_type, "prim:reverse!", 2, &reverse_x, a);
	...
	/* src/module.mes */
	a = init_builtin(builtin_type, "prim:make-module-type", 0, &make_module_type, a);
	a = init_builtin(builtin_type, "prim:module-printer", 1, &module_printer, a);
	a = init_builtin(builtin_type, "prim:module-variable", 2, &module_variable, a);
	a = init_builtin(builtin_type, "prim:module-ref", 2, &module_ref, a);
	...
	a = init_builtin(builtin_type, "prim:getenv", 1, &get_env, a);
	a = init_builtin(builtin_type, "prim:setenv", 2, &set_env, a);
	...
	a = init_builtin(builtin_type, "prim:chmod", 2, &file_chmod, a);
	a = init_builtin(builtin_type, "prim:isatty?", 1, &isatty_p, a);
	a = init_builtin(builtin_type, "prim:primitive-fork", 0, &primitive_fork, a);
	a = init_builtin(builtin_type, "prim:execl", 2, &exec, a);
	a = init_builtin(builtin_type, "prim:waitpid", 2, &wait_pid, a);
	a = init_builtin(builtin_type, "prim:getcwd", 0, &get_cwd, a);
	a = init_builtin(builtin_type, "prim:dup", 1, &file_dup, a);
	a = init_builtin(builtin_type, "prim:dup2", 2, &file_dup2, a);
	a = init_builtin(builtin_type, "prim:delete-file", 1, &delete_file, a);
	/* src/reader.mes */
	a = init_builtin(builtin_type, "prim:read-input-file-env", 2, &read_input_file_env, a);
	...
	/* src/strings.mes */
	a = init_builtin(builtin_type, "prim:string=?", 2, &string_equal_p, a);
	a = init_builtin(builtin_type, "prim:symbol->string", 1, &symbol_to_string, a);
	a = init_builtin(builtin_type, "prim:symbol->keyword", 1, &symbol_to_keyword, a);
	...
	a = init_builtin(builtin_type, "prim:make-symbol", 1, &make_symbol, a);
	...
	/* src/vector.mes */
	a = init_builtin(builtin_type, "prim:make-vector", 1, &make_vector, a);
